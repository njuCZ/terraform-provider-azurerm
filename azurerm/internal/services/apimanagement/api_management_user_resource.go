...
func resourceArmApiManagementUserCreateUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if _, err := client.CreateOrUpdate(ctx, resourceGroup, serviceName, userId, properties, utils.Bool(false), ""); err != nil {
...
func resourceArmApiManagementUserDelete(d *schema.ResourceData, meta interface{}) error {
	...
	resp, err := client.Delete(ctx, resourceGroup, serviceName, userId, "", deleteSubscriptions, notify, apimanagement.Portal)
	if err != nil {
