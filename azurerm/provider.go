...
func Provider() terraform.ResourceProvider {
	...
	dataSources := map[string]*schema.Resource{
		...
		"azurerm_spring_cloud":                              dataSourceArmSpringCloud(),
		"azurerm_spring_cloud_app":                          dataSourceArmSpringCloudApp(),
		"azurerm_spring_cloud_app_binding":                  dataSourceArmSpringCloudAppBinding(),
		"azurerm_spring_cloud_config_server":                dataSourceArmSpringCloudConfigServer(),
		"azurerm_spring_cloud_deployment":                   dataSourceArmArmSpringCloudDeployment(),
	...
	resources := map[string]*schema.Resource{
		...
		"azurerm_spring_cloud":                                                           resourceArmSpringCloud(),
		...
		"azurerm_spring_cloud_app_cosmosdb_binding":                                      resourceArmSpringCloudAppCosmosDBBinding(),
